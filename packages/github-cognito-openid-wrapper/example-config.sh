...
export LINKEDIN_CLIENT_ID=# <GitHub OAuth App Client ID>
export LINKEDIN_CLIENT_SECRET=# <GitHub OAuth App Client Secret>
...
# LINKEDIN_API_URL=# https://<GitHub Enterprise Host>/api/v3
# LINKEDIN_LOGIN_URL=# https://<GitHub Enterprise Host>
